...
// index. However, the key is not stored explicitly, but can
// be calculated as the sum of the sizes of the left child
// of the ancestors where the node is in the right subtree
// of it. (commented parts are specific to range sum queries
// and other problems)
