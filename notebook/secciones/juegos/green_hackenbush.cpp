// A two-player game played on an undirected graph where some nodes 
// are connected to the ground. On each turn, a player removes an edge. 
// If this removal splits the graph into two components, any component 
// that is not connected to the ground is removed. A player loses the game 
